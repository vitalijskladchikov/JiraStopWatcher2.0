    ...
    internal class IssueControl : UserControl
    {
        ...
        public void UpdateOutput(bool updateSummary = false)
        {
            ...
            if (WatchTimer.Running)
            {
                ...
                if(this.settings.AutomaticCalcTime)
                {
            ...
            btnPostAndReset.Enabled = (this.settings.AutomaticCalcTime ? (WatchTimer.TimeElapsed.TotalMinutes >= 1) : true);
        ...
        private void InitializeComponent()
        {
            ...
            this.tbTime.ReadOnly = Properties.Settings.Default.AutomaticCalcTime;
